...
#define _hcca                       _ohci0_hcca
#define _Ied                        _ohci0_Ied
#define ed_remove_list              _ohci0_ed_remove_list
#define add_to_ED_remove_list       _ohci0_add_to_ED_remove_list
#define ohci_reset                  _ohci0_ohci_reset
#define init_hcca_int_table         _ohci0_init_hcca_int_table
#define get_int_tree_head_node      _ohci0_get_int_tree_head_node
#define get_ohci_interval           _ohci0_get_ohci_interval
#define ed_make_info                _ohci0_ed_make_info
#define write_td                    _ohci0_write_td
#define ohci_find_device_by_port    _ohci0_ohci_find_device_by_port
#define ohci_init                   _ohci0_ohci_init
#define ohci_suspend                _ohci0_ohci_suspend
#define ohci_resume                 _ohci0_ohci_resume
#define ohci_shutdown               _ohci0_ohci_shutdown
#define ohci_ctrl_xfer              _ohci0_ohci_ctrl_xfer
#define ohci_bulk_xfer              _ohci0_ohci_bulk_xfer
#define ohci_int_xfer               _ohci0_ohci_int_xfer
#define ohci_iso_xfer               _ohci0_ohci_iso_xfer
#define ohci_quit_xfer              _ohci0_ohci_quit_xfer
#define ohci_rh_port_reset          _ohci0_ohci_rh_port_reset
#define ohci_rh_polling             _ohci0_ohci_rh_polling
#define remove_ed                   _ohci0_remove_ed
#define td_done                     _ohci0_td_done
#define dump_ohci_regs              _ohci0_dump_ohci_regs
#define dump_ohci_ports             _ohci0_dump_ohci_ports
...
void dump_ohci0_int_table(void)
{
    int    i;
