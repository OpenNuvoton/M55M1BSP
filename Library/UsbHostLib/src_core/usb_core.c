...
#ifdef ENABLE_OHCI0
    ohci0_driver.init();
    USB_debug("OHCI0 init done.\n");
    ENABLE_OHCI0_IRQ();
#endif

#ifdef ENABLE_OHCI1
    ohci1_driver.init();
    USB_debug("OHCI1 init done.\n");
    ENABLE_OHCI1_IRQ();
#endif
...
void usbh_suspend(void)
{
...
#ifdef ENABLE_OHCI0
    uint32_t ohci0_HcControl_tamp = 0U;
    ...
    _ohci0->HcControl = ((ohci0_HcControl_tamp & ~USBH_HcControl_HCFS_Msk) | (3U << USBH_HcControl_HCFS_Pos));
#endif

#ifdef ENABLE_OHCI1
    uint32_t ohci1_HcControl_tamp = 0U;
    ...
    _ohci1->HcControl = ((ohci1_HcControl_tamp & ~USBH_HcControl_HCFS_Msk) | (3U << USBH_HcControl_HCFS_Pos));
#endif
...
void usbh_resume(void)
{
    ...
    /*hydra*/
    ohci0_HcControl_tamp = _ohci0->HcControl;
    _ohci0->HcControl = (ohci0_HcControl_tamp & ~USBH_HcControl_HCFS_Msk) | (1U << USBH_HcControl_HCFS_Pos);
    ...
    delay_us(30000);                       /* wait at least 30ms for Host to resume device */

    /* enter operational state */
    ohci0_HcControl_tamp = _ohci0->HcControl;
    _ohci0->HcControl = (ohci0_HcControl_tamp & ~USBH_HcControl_HCFS_Msk) | (2U << USBH_HcControl_HCFS_Pos);
#endif
    ...
    if (_ehci->UPSCR[0] & HSUSBH_UPSCR_PE_Msk)
    {
        ...
        delay_us(25000);                         /* keep resume signal for 25 ms */
        _ehci->UPSCR[0] &= ~HSUSBH_UPSCR_FPR_Msk;
    }
    ...
    /*Synopsys*/
    ohci1_HcControl_tamp = _ohci1->HcControl;
    _ohci1->HcControl = (ohci1_HcControl_tamp & ~USBH_HcControl_HCFS_Msk) | (1U << USBH_HcControl_HCFS_Pos);
    ...
    /* enter operational state */
    ohci1_HcControl_tamp = _ohci1->HcControl;
    _ohci1->HcControl = (ohci1_HcControl_tamp & ~USBH_HcControl_HCFS_Msk) | (2U << USBH_HcControl_HCFS_Pos);
#endif
