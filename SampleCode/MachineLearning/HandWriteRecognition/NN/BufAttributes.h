...
#ifndef BUF_ATTRIBUTES_H
#define BUF_ATTRIBUTES_H
    ...
    #define LABEL_SECTION               section("labels")
        ...
        //#warning  "ACTIVATION_BUF_SZ needs to be defined. Using default value 0x23000"
        #define ACTIVATION_BUF_SZ       0x23000//0x00200000
