...
#pragma GCC diagnostic pop
    ...
    template < typename U = value_type,
               ...
               enable_constructor_from_value<T, U> * = nullptr > optional(U && other) noexcept  // NOLINT(*)
    {
    ...
    template <typename U,
              ...
              enable_if_t<std::is_convertible<const U &, T>::value> * = nullptr> optional(const optional<U> &other)
    {
        if (other.has_value())
        {
            construct(*other);
    ...
    template < typename U, enable_constructor_from_other < T, U, U && > * = nullptr,
               enable_if_t < std::is_convertible < U &&, T >::value > * = nullptr > optional(optional<U> &&other)
    {
        if (other.has_value())
        {
