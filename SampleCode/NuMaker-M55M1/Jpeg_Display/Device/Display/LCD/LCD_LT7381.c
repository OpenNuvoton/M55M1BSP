...
static int32_t lt7381_init(void)
{
    ...
    printf("enter  lt7381_wait_ready.\r\n");
    lt7381_wait_ready();
    printf("exit  lt7381_wait_ready.\r\n");

    printf("enter  lt7381_sw_reset.\r\n");
    /* Software reset */
    lt7381_sw_reset();
    printf("exit  lt7381_sw_reset.\r\n");
