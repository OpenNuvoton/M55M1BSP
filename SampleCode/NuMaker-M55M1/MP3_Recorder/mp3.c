...
void MP3Player(void)
{
    ...
    I2S_Open(I2S_PORT, I2S_MODE_SLAVE, 16000, I2S_DATABIT_16, PLAY_FORMAT, I2S_FORMAT_I2S);
    ...
    I2S_PORT->CTL1 |= I2S_CTL1_PBWIDTH_Msk;
#else
    SPII2S_Open(SPI_PORT, SPII2S_MODE_SLAVE, 16000, SPII2S_DATABIT_16, SPII2S_MONO, SPII2S_FORMAT_I2S);
