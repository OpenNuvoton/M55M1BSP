...
static _E_MQTT_TCP_ERRORS __map_ssl_err(int32_t err)
{
    ...
    switch (err)
    {
        ...
        case -0x7380:   //MBEDTLS_ERR_SSL_NO_CIPHER_CHOSEN:
        ...
        case -0x7900:   //BEDTLS_ERR_SSL_BAD_HS_CLIENT_HELLO:
            return MQTT_SSL_BAD_HS_CLIENT_HELLO;

        case -0x7980:   //MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO:
            return MQTT_SSL_BAD_HS_SERVER_HELLO;

        case MBEDTLS_ERR_SSL_BAD_CERTIFICATE:
            return MQTT_SSL_BAD_HS_CERTIFICATE;

        case -0x7A80:   //MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_REQUEST:
            return MQTT_SSL_BAD_HS_SERVER_KEY_EXCHANGE;

        case -0x7B00:   //MBEDTLS_ERR_SSL_BAD_HS_SERVER_KEY_EXCHANGE:
            return MQTT_SSL_BAD_HS_SERVER_KEY_EXCHANGE;

        case -0x7B80:   //MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO_DONE:
            return MQTT_SSL_BAD_HS_SERVER_HELLO_DONE;

        case -0x7C00:   //MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE:
            return MQTT_SSL_BAD_HS_CLIENT_KEY_EXCHANGE;

        case -0x7C80:   //MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_RP:
            return MQTT_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_RP;

        case -0x7D00:   //MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_CS:
            return MQTT_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_CS;

        case -0x7D80:   //MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_VERIFY:
            return MQTT_SSL_BAD_HS_CERTIFICATE_VERIFY;

        case -0x7E00:   //MBEDTLS_ERR_SSL_BAD_HS_CHANGE_CIPHER_SPEC:
            return MQTT_SSL_BAD_HS_CHANGE_CIPHER_SPEC;

        case -0x7E80:   //MBEDTLS_ERR_SSL_BAD_HS_FINISHED:
        ...
        case -0x6F00:   //MBEDTLS_ERR_SSL_COMPRESSION_FAILED:
        ...
        case -0x6980:   //MBEDTLS_ERR_SSL_NO_USABLE_CIPHERSUITE:
