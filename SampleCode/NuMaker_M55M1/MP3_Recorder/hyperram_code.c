...
/**
  ...
  * @return     None.
  */
static void SPIM_Hyper_DefaultConfig(SPIM_T *spim, uint32_t u32CSMTime, uint32_t u32AcctRD, uint32_t u32AcctWR)
{
    ...
    uint32_t u32CSMAXLT = (uint32_t)((u32CSMTime / fFreq) - (2 * 8 * u32DIV) - ((u32CipherEn == SPIM_HYPER_OP_ENABLE) ? 21 : 54));
    ...
    /* Chip Select High between Transaction as 4 HCLK cycles */
