 ...
 * @file     rndis.h
 * @version  V3.00
 * @brief    HSUSBD RNDIS header file.
 *
...
{
    uint8_t data[RQ_SZ][1580]; /* Packet buffer: rndis_msg_header 44-byte header + PKT_FRAME_BUF_SIZE payload (1580) */
