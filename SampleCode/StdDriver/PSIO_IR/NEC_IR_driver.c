...
void PSIO_NEC_Open(S_PSIO_NEC_CFG *pConfig)
{
    ...
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT0, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT1, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT2, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT3, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT4, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT5, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT6, 9UL);
    PSIO_SCSLOT_SET_SLOT(PSIO, pConfig->u8SlotCtrl, PSIO_SLOT7, 9UL);
