...
//------------------------------------------------------------------------------
#if (NVT_DCACHE_ON == 1)
    NVT_NONCACHEABLE __ALIGNED(32) DESC_TABLE_T g_asDescTable_TX[2], g_asDescTable_RX[2];
    NVT_NONCACHEABLE uint32_t PcmRxBuff[2][BUFF_LEN];
    NVT_NONCACHEABLE uint32_t PcmTxBuff[2][BUFF_LEN];
#else
