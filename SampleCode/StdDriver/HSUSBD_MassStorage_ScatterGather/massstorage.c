...
typedef struct
{
...
#if (NVT_DCACHE_ON == 1)
    uint8_t SCATTER_DATA_BUFFER[DCACHE_ALIGN_LINE_SIZE(16 * 1024)] __attribute__((aligned(DCACHE_LINE_SIZE)));
#else
    ...
    */
    NVT_NONCACHEABLE SCATTER_GATHER scater_gather_array[8];
#else
