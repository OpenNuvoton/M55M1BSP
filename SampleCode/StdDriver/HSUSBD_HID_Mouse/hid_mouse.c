...
NVT_ITCM void HSUSBD_IRQHandler(void)
{
    ...
    if (IrqStL & HSUSBD_GINTSTS_USBIF_Msk)
    {
        ...
        if (IrqSt & HSUSBD_BUSINTSTS_RSTIF_Msk)
        {
            ...
            HSUSBD_SET_ADDR(0);
#ifdef SUPPORT_LPM
            HSUSBD_ENABLE_BUS_INT(HSUSBD_BUSINTEN_RSTIEN_Msk | HSUSBD_BUSINTEN_RESUMEIEN_Msk | HSUSBD_BUSINTEN_SUSPENDIEN_Msk | HSUSBD_BUSINTEN_LPMTKNIEN_Msk);
#else
...
#ifdef SUPPORT_LPM
            HSUSBD_ENABLE_BUS_INT(HSUSBD_BUSINTEN_RSTIEN_Msk | HSUSBD_BUSINTEN_SUSPENDIEN_Msk | HSUSBD_BUSINTEN_LPMTKNIEN_Msk);
#else
...
#ifdef SUPPORT_LPM
            HSUSBD_ENABLE_BUS_INT(HSUSBD_BUSINTEN_RSTIEN_Msk | HSUSBD_BUSINTEN_RESUMEIEN_Msk | HSUSBD_BUSINTEN_LPMTKNIEN_Msk);
#else
...
#ifdef SUPPORT_LPM
            HSUSBD->LPMCSR |= HSUSBD_LPMCSR_LPMSLEEPEN_Msk;
#endif
