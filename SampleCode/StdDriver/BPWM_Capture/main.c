...
int main(void)
{
    ...
    while (1)
    {
        ...
        /* Assume BPWM output frequency is 250Hz and duty ratio is 30%, user can calculate BPWM settings by follows.(up counter type)
           ...
           cycle time = CNR+1
           High level = CMR
           BPWM clock source frequency = PLL/2 = 110000000
        ...
        */
        ...
        /* If input minimum frequency is 250Hz, user can calculate capture settings by follows.
           Capture clock source frequency = PLL = 110000000 in the sample code.
           ...
           64 ns = 1000000000/110000000*7
        */

        /* Set BPWM0 channel 0 capture configuration */
        BPWM_ConfigCaptureChannel(BPWM0, 0, 64, 0);
