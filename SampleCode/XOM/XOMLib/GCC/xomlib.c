...
/*------------------------------*/
#define XOM_ADD_ADDR    0x00104001
#define XOM_SUB_ADDR    0x00104005
#define XOM_MUL_ADDR    0x00104009
#define XOM_DIV_ADDR    0x0010400D
#define XOM_SUM_ADDR    0x00104013
