 ...
 * @file    xomlib.c
 * @version V3.00
 * @brief   Template file to declare function pointer for XOM APIs.
 *
...
/* Copy XOMLib address definitions from XOMLib_Code "[1] Test XOM" to build XOMLib. */
/*------------------------------*/
/*  XOMLib address definitions  */
/*------------------------------*/
#define XOM_ADD_ADDR    0xXXXXXXXX
#define XOM_SUB_ADDR    0xXXXXXXXX
#define XOM_MUL_ADDR    0xXXXXXXXX
#define XOM_DIV_ADDR    0xXXXXXXXX
#define XOM_SUM_ADDR    0xXXXXXXXX
